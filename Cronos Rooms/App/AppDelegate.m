...
- (void)styleNavigationController {
    //general properties
    self.navigationController.navigationBar.barTintColor = [UIColor app_blueGreyShaded];
    self.navigationController.navigationBar.tintColor = [UIColor app_darkGrey];
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"Cronos_Rooms" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"Cronos_Rooms.sqlite"];
